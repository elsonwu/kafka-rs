...
<head>
    <title>Code coverage report for confluent-kafka-javascript/lib/topic.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">confluent-kafka-javascript/lib</a> topic.js</h1>
        <div class='clearfix'>
...
for (var key in librdkafka.topic) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (key.indexOf('RdKafka::Topic::') !== 0) {
 ...
 * @private
 */
function <span class="fstat-no" title="function not covered" >Topic(</span>topicName) {
<span class="cstat-no" title="statement not covered" >  return topicName;</span>
}
&nbsp;</pre></td></tr></table></pre>
