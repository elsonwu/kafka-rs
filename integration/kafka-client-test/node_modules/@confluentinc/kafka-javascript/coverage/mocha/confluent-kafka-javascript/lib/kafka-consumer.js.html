...
<head>
    <title>Code coverage report for confluent-kafka-javascript/lib/kafka-consumer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">confluent-kafka-javascript/lib</a> kafka-consumer.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">29.32% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>61/208</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>12/90</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">2.32% </span>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">29.46% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>61/207</span>
            </div>
...
<a name='L798'></a><a href='#L798'>798</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
function KafkaConsumer(conf, topicConf) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof KafkaConsumer)) {
<span class="cstat-no" title="statement not covered" >    return new KafkaConsumer(conf, topicConf);</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (onRebalance &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof onRebalance === 'boolean')</span> {
<span class="cstat-no" title="statement not covered" >    conf.rebalance_cb = <span class="fstat-no" title="function not covered" >fu</span>nction(err, assignment) {</span>
      // Create the librdkafka error
<span class="cstat-no" title="statement not covered" >      err = LibrdKafkaError.create(err);</span>
      // Emit the event
<span class="cstat-no" title="statement not covered" >      self.emit('rebalance', err, assignment);</span>
&nbsp;
      // That's it
<span class="cstat-no" title="statement not covered" >      try {</span>
<span class="cstat-no" title="statement not covered" >        if (err.code === -175 /*ERR__ASSIGN_PARTITIONS*/) {</span>
<span class="cstat-no" title="statement not covered" >          if (self.rebalanceProtocol() === 'COOPERATIVE') {</span>
<span class="cstat-no" title="statement not covered" >            self.incrementalAssign(assignment);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            self.assign(assignment);</span>
          }
        } else <span class="cstat-no" title="statement not covered" >if (err.code === -174 /*ERR__REVOKE_PARTITIONS*/) {</span>
<span class="cstat-no" title="statement not covered" >          if (self.rebalanceProtocol() === 'COOPERATIVE') {</span>
<span class="cstat-no" title="statement not covered" >            self.incrementalUnassign(assignment);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            self.unassign();</span>
          }
        }
      } catch (e) {
        // Ignore exceptions if we are not connected
<span class="cstat-no" title="statement not covered" >        if (self.isConnected()) {</span>
<span class="cstat-no" title="statement not covered" >          self.emit('rebalance.error', e);</span>
        }
      }
    };
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (onRebalance &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof onRebalance === 'function')</span> {
    /*
...
<span class="cstat-no" title="statement not covered" >     conf.rebalance_cb = <span class="fstat-no" title="function not covered" >fu</span>nction(err, assignment) {</span>
       // Create the librdkafka error
<span class="cstat-no" title="statement not covered" >       err = err ? LibrdKafkaError.create(err) : undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >       self.emit('rebalance', err, assignment);</span>
<span class="cstat-no" title="statement not covered" >       onRebalance.call(self, err, assignment);</span>
     };
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (onOffsetCommit &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof onOffsetCommit === 'boolean')</span> {
<span class="cstat-no" title="statement not covered" >    conf.offset_commit_cb = <span class="fstat-no" title="function not covered" >fu</span>nction(err, offsets) {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        err = LibrdKafkaError.create(err);</span>
      }
      // Emit the event
<span class="cstat-no" title="statement not covered" >      self.emit('offset.commit', err, offsets);</span>
    };
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (onOffsetCommit &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof onOffsetCommit === 'function')</span> {
<span class="cstat-no" title="statement not covered" >    conf.offset_commit_cb = <span class="fstat-no" title="function not covered" >fu</span>nction(err, offsets) {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        err = LibrdKafkaError.create(err);</span>
      }
      // Emit the event
<span class="cstat-no" title="statement not covered" >      self.emit('offset.commit', err, offsets);</span>
<span class="cstat-no" title="statement not covered" >      onOffsetCommit.call(self, err, offsets);</span>
    };
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (queue_non_empty_cb) {
<span class="cstat-no" title="statement not covered" >    this._cb_configs.event.queue_non_empty_cb = queue_non_empty_cb;</span>
  }
}
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.setDefaultConsumeTimeout = <span class="fstat-no" title="function not covered" >fu</span>nction(timeoutMs) {
<span class="cstat-no" title="statement not covered" >  this._consumeTimeout = timeoutMs;</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.setDefaultConsumeLoopTimeoutDelay = <span class="fstat-no" title="function not covered" >fu</span>nction(intervalMs) {
<span class="cstat-no" title="statement not covered" >  this._consumeLoopTimeoutDelay = intervalMs;</span>
};
&nbsp;
/**
 * If true:
 ...
 * @private
 */
KafkaConsumer.prototype.setDefaultIsTimeoutOnlyForFirstMessage = <span class="fstat-no" title="function not covered" >fu</span>nction(isTimeoutOnlyForFirstMessage) {
<span class="cstat-no" title="statement not covered" >  this._consumeIsTimeoutOnlyForFirstMessage = isTimeoutOnlyForFirstMessage;</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.createReadStream = <span class="fstat-no" title="function not covered" >fu</span>nction(conf, topicConf, streamOptions) {
  var consumer = <span class="cstat-no" title="statement not covered" >new KafkaConsumer(conf, topicConf);</span>
<span class="cstat-no" title="statement not covered" >  return new KafkaConsumerStream(consumer, streamOptions);</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.committed = <span class="fstat-no" title="function not covered" >fu</span>nction(toppars, timeout, cb) {
...
<span class="cstat-no" title="statement not covered" >    timeout = arguments[0];</span>
<span class="cstat-no" title="statement not covered" >    toppars = this.assignments();</span>
  } else {
<span class="cstat-no" title="statement not covered" >    toppars = toppars || this.assignments();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.committed(toppars, timeout, <span class="fstat-no" title="function not covered" >fu</span>nction(err, topicPartitions) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      cb(LibrdKafkaError.create(err));</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    cb(null, topicPartitions);</span>
  });
 ...
 * @return {RdKafka.KafkaConsumer} - Returns itself.
 */
KafkaConsumer.prototype.seek = <span class="fstat-no" title="function not covered" >fu</span>nction(toppar, timeout, cb) {
<span class="cstat-no" title="statement not covered" >  this._client.seek(TopicPartition.create(toppar), timeout, <span class="fstat-no" title="function not covered" >fu</span>nction(err) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      cb(LibrdKafkaError.create(err));</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
 ...
 */
KafkaConsumer.prototype.assign = <span class="fstat-no" title="function not covered" >fu</span>nction(assignments) {
<span class="cstat-no" title="statement not covered" >  this._client.assign(TopicPartition.map(assignments));</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
&nbsp;
KafkaConsumer.prototype.unassign = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >  this._client.unassign();</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.incrementalAssign = <span class="fstat-no" title="function not covered" >fu</span>nction(assignments) {
<span class="cstat-no" title="statement not covered" >  this._client.incrementalAssign(TopicPartition.map(assignments));</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.incrementalUnassign = <span class="fstat-no" title="function not covered" >fu</span>nction(assignments) {
<span class="cstat-no" title="statement not covered" >  this._client.incrementalUnassign(TopicPartition.map(assignments));</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.assignments = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >  return this._errorWrap(this._client.assignments(), true);</span>
};
&nbsp;
/**
 ...
 */
&nbsp;
KafkaConsumer.prototype.assignmentLost = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >  return this._client.assignmentLost();</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.rebalanceProtocol = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >  return this._client.rebalanceProtocol();</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.subscribe = <span class="fstat-no" title="function not covered" >fu</span>nction(topics) {
  // Will throw if it is a bad error.
<span class="cstat-no" title="statement not covered" >  this._errorWrap(this._client.subscribe(topics));</span>
  /**
   ...
   * @type {Array&lt;string&gt;}
   */
<span class="cstat-no" title="statement not covered" >  this.emit('subscribed', topics);</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.subscription = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >  return this._errorWrap(this._client.subscription(), true);</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.position = <span class="fstat-no" title="function not covered" >fu</span>nction(toppars) {
<span class="cstat-no" title="statement not covered" >  if (!toppars) {</span>
<span class="cstat-no" title="statement not covered" >    toppars = this.assignments();</span>
  }
<span class="cstat-no" title="statement not covered" >  return this._errorWrap(this._client.position(toppars), true);</span>
};
&nbsp;
/**
 ...
 * @return {RdKafka.KafkaConsumer} - Returns itself.
 */
KafkaConsumer.prototype.unsubscribe = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >  this._errorWrap(this._client.unsubscribe());</span>
<span class="cstat-no" title="statement not covered" >  this.emit('unsubscribed', []);</span>
 ...
 */
KafkaConsumer.prototype.consume = <span class="fstat-no" title="function not covered" >fu</span>nction(number, cb) {
  var timeoutMs = <span class="cstat-no" title="statement not covered" >this._consumeTimeout !== undefined ? this._consumeTimeout : DEFAULT_CONSUME_TIME_OUT;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if ((number &amp;&amp; typeof number === 'number') || (number &amp;&amp; cb)) {</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._consumeNum(timeoutMs, number, cb);</span>
  } else {
&nbsp;
    ...
    // @deprecated
<span class="cstat-no" title="statement not covered" >    if (cb === undefined) {</span>
<span class="cstat-no" title="statement not covered" >      if (typeof number === 'function') {</span>
<span class="cstat-no" title="statement not covered" >        cb = number;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        cb = <span class="fstat-no" title="function not covered" >fu</span>nction() {};</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._consumeLoop(timeoutMs, cb);</span>
  }
};
&nbsp;
/**
 ...
 * @see consume
 */
KafkaConsumer.prototype._consumeLoop = <span class="fstat-no" title="function not covered" >fu</span>nction(timeoutMs, cb) {
  var self = <span class="cstat-no" title="statement not covered" >this;</span>
  var retryReadInterval = <span class="cstat-no" title="statement not covered" >this._consumeLoopTimeoutDelay;</span>
<span class="cstat-no" title="statement not covered" >  self._client.consumeLoop(timeoutMs, retryReadInterval, function <span class="fstat-no" title="function not covered" >readCallback(</span>err, message, eofEvent, warning) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
...
<span class="cstat-no" title="statement not covered" >      cb(LibrdKafkaError.create(err));</span>
    } else <span class="cstat-no" title="statement not covered" >if (eofEvent) {</span>
<span class="cstat-no" title="statement not covered" >      self.emit('partition.eof', eofEvent);</span>
    } else <span class="cstat-no" title="statement not covered" >if (warning) {</span>
<span class="cstat-no" title="statement not covered" >      self.emit('warning', LibrdKafkaError.create(warning));</span>
    } else {
      /**
       ...
       */
<span class="cstat-no" title="statement not covered" >      self.emit('data', message);</span>
<span class="cstat-no" title="statement not covered" >      cb(err, message);</span>
    }
  });
&nbsp;
};
 ...
 * @see consume
 */
KafkaConsumer.prototype._consumeNum = <span class="fstat-no" title="function not covered" >fu</span>nction(timeoutMs, numMessages, cb) {
  var self = <span class="cstat-no" title="statement not covered" >this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.consume(timeoutMs, numMessages, this._consumeIsTimeoutOnlyForFirstMessage, <span class="fstat-no" title="function not covered" >fu</span>nction(err, messages, eofEvents) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      err = LibrdKafkaError.create(err);</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
...
&nbsp;
    var currentEofEventsIndex = <span class="cstat-no" title="statement not covered" >0;</span>
&nbsp;
    function <span class="fstat-no" title="function not covered" >emitEofEventsFor(</span>messageIndex) {
<span class="cstat-no" title="statement not covered" >      while (currentEofEventsIndex &lt; eofEvents.length &amp;&amp; eofEvents[currentEofEventsIndex].messageIndex === messageIndex) {</span>
<span class="cstat-no" title="statement not covered" >        delete eofEvents[currentEofEventsIndex].messageIndex;</span>
<span class="cstat-no" title="statement not covered" >        self.emit('partition.eof', eofEvents[currentEofEventsIndex]);</span>
<span class="cstat-no" title="statement not covered" >        ++currentEofEventsIndex;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    emitEofEventsFor(-1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (var i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; messages.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >      self.emit('data', messages[i]);</span>
<span class="cstat-no" title="statement not covered" >      emitEofEventsFor(i);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    emitEofEventsFor(messages.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cb) {</span>
<span class="cstat-no" title="statement not covered" >      cb(null, messages);</span>
    }
&nbsp;
  });
&nbsp;
 ...
 * @return {RdKafka.KafkaConsumer} - returns itself.
 */
KafkaConsumer.prototype.commit = <span class="fstat-no" title="function not covered" >fu</span>nction(topicPartition) {
<span class="cstat-no" title="statement not covered" >  this._errorWrap(this._client.commit(topicPartition), true);</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 * @return {RdKafka.KafkaConsumer} - returns itself.
 */
KafkaConsumer.prototype.commitMessage = <span class="fstat-no" title="function not covered" >fu</span>nction(msg) {
  var topicPartition = <span class="cstat-no" title="statement not covered" >{</span>
    topic: msg.topic,
 ...
 * @return {RdKafka.KafkaConsumer} - returns itself.
 */
KafkaConsumer.prototype.commitSync = <span class="fstat-no" title="function not covered" >fu</span>nction(topicPartition) {
<span class="cstat-no" title="statement not covered" >  this._errorWrap(this._client.commitSync(topicPartition), true);</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 * @return {RdKafka.KafkaConsumer} - returns itself.
 */
KafkaConsumer.prototype.commitMessageSync = <span class="fstat-no" title="function not covered" >fu</span>nction(msg) {
  var topicPartition = <span class="cstat-no" title="statement not covered" >{</span>
    topic: msg.topic,
    partition: msg.partition,
    offset: msg.offset + 1,
 ...
 * @return {RdKafka.KafkaConsumer} - returns itself.
 */
KafkaConsumer.prototype.commitCb = <span class="fstat-no" title="function not covered" >fu</span>nction(toppars, cb) {
<span class="cstat-no" title="statement not covered" >  this._client.commitCb(toppars, <span class="fstat-no" title="function not covered" >fu</span>nction(err) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      cb(LibrdKafkaError.create(err));</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
 ...
 */
KafkaConsumer.prototype.getWatermarkOffsets = <span class="fstat-no" title="function not covered" >fu</span>nction(topic, partition) {
<span class="cstat-no" title="statement not covered" >  if (!this.isConnected()) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this._errorWrap(this._client.getWatermarkOffsets(topic, partition), true);</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.offsetsStore = <span class="fstat-no" title="function not covered" >fu</span>nction(topicPartitions) {
<span class="cstat-no" title="statement not covered" >  if (!this.isConnected()) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this._errorWrap(this._client.offsetsStore(topicPartitions), true);</span>
};
&nbsp;
/**
 ...
 * @private
 */
KafkaConsumer.prototype._offsetsStoreSingle = <span class="fstat-no" title="function not covered" >fu</span>nction(topic, partition, offset, leaderEpoch) {
<span class="cstat-no" title="statement not covered" >  if (!this.isConnected()) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this._errorWrap(</span>
 ...
 */
KafkaConsumer.prototype.resume = <span class="fstat-no" title="function not covered" >fu</span>nction(topicPartitions) {
<span class="cstat-no" title="statement not covered" >  if (!this.isConnected()) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this._errorWrap(this._client.resume(topicPartitions), true);</span>
};
&nbsp;
/**
 ...
 */
KafkaConsumer.prototype.pause = <span class="fstat-no" title="function not covered" >fu</span>nction(topicPartitions) {
<span class="cstat-no" title="statement not covered" >  if (!this.isConnected()) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this._errorWrap(this._client.pause(topicPartitions), true);</span>
};
&nbsp;
/**
