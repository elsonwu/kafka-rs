    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">83.46% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>106/127</span>
            </div>
...
function ProducerStream(producer, options) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof ProducerStream)) {
...
<span class="cstat-no" title="statement not covered" >    options = {};</span>
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options === 'string') {
...
ProducerStream.prototype.connect = function(options) {
  this.producer.connect(options, <span class="fstat-no" title="function not covered" >fu</span>nction(err) {
...
ProducerStream.prototype._write_buffer = function(data, encoding, cb) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(data instanceof Buffer)) {
...
ProducerStream.prototype._writev = function(data, cb) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.producer.isConnected()) {
...
&nbsp;
  ...
  if (self.producer._isConnected) {
    self.producer.disconnect(<span class="fstat-no" title="function not covered" >fu</span>nction() {
...
<span class="cstat-no" title="statement not covered" >      close();</span>
  ...
  } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="else path not taken" >E</span>if (self.producer._isConnecting){</span>
