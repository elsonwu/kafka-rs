...
<head>
    <title>Code coverage report for confluent-kafka-javascript/lib/producer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">confluent-kafka-javascript/lib</a> producer.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">39.16% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>47/120</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">24.28% </span>
...
function Producer(conf, topicConf) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof Producer)) {
<span class="cstat-no" title="statement not covered" >    return new Producer(conf, topicConf);</span>
  }
&nbsp;
...
&nbsp;
  ...
  this.defaultPartition = gPart === null ? -1 : <span class="branch-1 cbranch-no" title="branch not covered" >gPart;</span>
&nbsp;
  this.sentMessages = 0;
&nbsp;
  this.pollInterval = undefined;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (dr_msg_cb || dr_cb) {
<span class="cstat-no" title="statement not covered" >    this._cb_configs.event.delivery_cb =  <span class="fstat-no" title="function not covered" >fu</span>nction(err, report) {</span>
<span class="cstat-no" title="statement not covered" >      if (err) {</span>
<span class="cstat-no" title="statement not covered" >        err = LibrdKafkaError.create(err);</span>
      }
<span class="cstat-no" title="statement not covered" >      this.emit('delivery-report', err, report);</span>
    }.bind(this);
<span class="cstat-no" title="statement not covered" >    this._cb_configs.event.delivery_cb.dr_msg_cb = !!dr_msg_cb;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (typeof dr_cb === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      this.on('delivery-report', dr_cb);</span>
    }
&nbsp;
  }
}
 ...
 */
Producer.prototype.produce = <span class="fstat-no" title="function not covered" >fu</span>nction(topic, partition, message, key, timestamp, opaque, headers) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Producer not connected');</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  if (!topic || typeof topic !== 'string') {</span>
<span class="cstat-no" title="statement not covered" >    throw new TypeError('"topic" must be a string');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.sentMessages++;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  partition = partition === null ? this.defaultPartition : partition;</span>
&nbsp;
 ...
 */
Producer.createWriteStream = <span class="fstat-no" title="function not covered" >fu</span>nction(conf, topicConf, streamOptions) {
  var producer = <span class="cstat-no" title="statement not covered" >new Producer(conf, topicConf);</span>
<span class="cstat-no" title="statement not covered" >  return new ProducerStream(producer, streamOptions);</span>
};
&nbsp;
/**
 * Poll for events.
 ...
 */
Producer.prototype.poll = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Producer not connected');</span>
  }
<span class="cstat-no" title="statement not covered" >  this._client.poll();</span>
 ...
 * @return {RdKafka.Producer} - returns itself.
 */
Producer.prototype.setPollInterval = <span class="fstat-no" title="function not covered" >fu</span>nction(interval) {
  // If we already have a poll interval we need to stop it
<span class="cstat-no" title="statement not covered" >  if (this.pollInterval) {</span>
<span class="cstat-no" title="statement not covered" >    clearInterval(this.pollInterval);</span>
<span class="cstat-no" title="statement not covered" >    this.pollInterval = undefined;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (interval === 0) {</span>
...
<span class="cstat-no" title="statement not covered" >      self.setPollInterval(interval);</span>
    });
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
  ...
  // Unref this interval
<span class="cstat-no" title="statement not covered" >  this.pollInterval = setInterval(<span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
...
<span class="cstat-no" title="statement not covered" >  this.once('disconnected', <span class="fstat-no" title="function not covered" >fu</span>nction() {</span>
    // Just rerun this function with interval 0. If any
    // poll interval is set, this will remove it
<span class="cstat-no" title="statement not covered" >    self.setPollInterval(0);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
 ...
 */
Producer.prototype.setPollInBackground = <span class="fstat-no" title="function not covered" >fu</span>nction(set) {
<span class="cstat-no" title="statement not covered" >  if (set) {</span>
<span class="cstat-no" title="statement not covered" >    this.setPollInterval(0); </span>// Clear poll interval from JS.
  }
<span class="cstat-no" title="statement not covered" >  this._client.setPollInBackground(set);</span>
<span class="cstat-no" title="statement not covered" >  return this;</span>
};
&nbsp;
/**
 ...
 * @return {RdKafka.Producer} - returns itself.
 */
Producer.prototype.flush = <span class="fstat-no" title="function not covered" >fu</span>nction(timeout, callback) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Producer not connected');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (timeout === undefined || timeout === null) {</span>
<span class="cstat-no" title="statement not covered" >    timeout = 500;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.flush(timeout, <span class="fstat-no" title="function not covered" >fu</span>nction(err) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      err = LibrdKafkaError.create(err);</span>
    }
&nbsp;
 ...
 * @return {RdKafka.Producer} - returns itself.
 */
Producer.prototype.initTransactions = <span class="fstat-no" title="function not covered" >fu</span>nction(timeout, cb) {
...
<span class="cstat-no" title="statement not covered" >  this._client.initTransactions(timeout, <span class="fstat-no" title="function not covered" >fu</span>nction(err) {</span>
<span class="cstat-no" title="statement not covered" >    cb(err ? LibrdKafkaError.create(err) : err);</span>
  });
};
&nbsp;
/**
 ...
 * @return {RdKafka.Producer} - returns itself.
 */
Producer.prototype.beginTransaction = <span class="fstat-no" title="function not covered" >fu</span>nction(cb) {
<span class="cstat-no" title="statement not covered" >  this._client.beginTransaction(<span class="fstat-no" title="function not covered" >fu</span>nction(err) {</span>
<span class="cstat-no" title="statement not covered" >    cb(err ? LibrdKafkaError.create(err) : err);</span>
  });
};
&nbsp;
 ...
 * @return {RdKafka.Producer} - returns itself.
 */
Producer.prototype.commitTransaction = <span class="fstat-no" title="function not covered" >fu</span>nction(timeout, cb) {
<span class="cstat-no" title="statement not covered" >  if (typeof timeout === 'function') {</span>
<span class="cstat-no" title="statement not covered" >    cb = timeout;</span>
<span class="cstat-no" title="statement not covered" >    timeout = 5000;</span>
  }
<span class="cstat-no" title="statement not covered" >  this._client.commitTransaction(timeout, <span class="fstat-no" title="function not covered" >fu</span>nction(err) {</span>
<span class="cstat-no" title="statement not covered" >    cb(err ? LibrdKafkaError.create(err) : err);</span>
  });
};
&nbsp;
 ...
 * @return {RdKafka.Producer} - returns itself.
 */
Producer.prototype.abortTransaction = <span class="fstat-no" title="function not covered" >fu</span>nction(timeout, cb) {
<span class="cstat-no" title="statement not covered" >  if (typeof timeout === 'function') {</span>
<span class="cstat-no" title="statement not covered" >    cb = timeout;</span>
<span class="cstat-no" title="statement not covered" >    timeout = 5000;</span>
  }
<span class="cstat-no" title="statement not covered" >  this._client.abortTransaction(timeout, <span class="fstat-no" title="function not covered" >fu</span>nction(err) {</span>
<span class="cstat-no" title="statement not covered" >    cb(err ? LibrdKafkaError.create(err) : err);</span>
  });
};
&nbsp;
 ...
 * @return {RdKafka.Producer} - returns itself.
 */
Producer.prototype.sendOffsetsToTransaction = <span class="fstat-no" title="function not covered" >fu</span>nction(offsets, consumer, timeout, cb) {
<span class="cstat-no" title="statement not covered" >  if (typeof timeout === 'function') {</span>
<span class="cstat-no" title="statement not covered" >    cb = timeout;</span>
<span class="cstat-no" title="statement not covered" >    timeout = 5000;</span>
  }
<span class="cstat-no" title="statement not covered" >  this._client.sendOffsetsToTransaction(offsets, consumer.getClient(), timeout, <span class="fstat-no" title="function not covered" >fu</span>nction(err) {</span>
<span class="cstat-no" title="statement not covered" >    cb(err ? LibrdKafkaError.create(err) : err);</span>
  });
};
&nbsp;</pre></td></tr></table></pre>
