    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>70/120</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>31/70</span>
            </div>
...
&nbsp;
  ...
  var dr_cb = conf.dr_cb || <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (dr_msg_cb || dr_cb) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof dr_cb === 'function') {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!topic || typeof topic !== 'string') {
<span class="cstat-no" title="statement not covered" >    throw new TypeError('"topic" must be a string');</span>
  }
&nbsp;
  this.sentMessages++;
&nbsp;
  partition = partition === null ? <span class="branch-0 cbranch-no" title="branch not covered" >this.defaultPartition </span>: partition;
&nbsp;
...
Producer.prototype.setPollInterval = function(interval) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this.pollInterval) {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (interval === 0) {
...
Producer.prototype.setPollInBackground = function(set) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (set) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (timeout === undefined || timeout === null) {
