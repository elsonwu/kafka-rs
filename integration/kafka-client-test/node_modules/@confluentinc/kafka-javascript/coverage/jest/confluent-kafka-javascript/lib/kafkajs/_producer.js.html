...
<head>
    <title>Code coverage report for confluent-kafka-javascript/lib/kafkajs/_producer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">confluent-kafka-javascript/lib/kafkajs</a> _producer.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">44.12% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>124/281</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>56/177</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">44.24% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>123/278</span>
            </div>
...
<a name='L849'></a><a href='#L849'>849</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const RdKafka = require('../rdkafka');
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(kjsConfig, 'createPartitioner')) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.createPartitioner(), { code: error.ErrorCodes.ERR__NOT_IMPLEMENTED });</span>
    }
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(kjsConfig, 'transactionTimeout')) {
<span class="cstat-no" title="statement not covered" >      rdKafkaConfig['transaction.timeout.ms'] = kjsConfig.transactionTimeout;</span>
    } else {
      rdKafkaConfig['transaction.timeout.ms'] = 60000;
    }
&nbsp;
    // `socket.timeout.ms` must be set &lt;= `transaction.timeout.ms` + 100
    <span class="missing-if-branch" title="if path not taken" >I</span>if (rdKafkaConfig['socket.timeout.ms'] &gt; rdKafkaConfig['transaction.timeout.ms'] + 100) {
<span class="cstat-no" title="statement not covered" >      rdKafkaConfig['socket.timeout.ms'] = rdKafkaConfig['transaction.timeout.ms'] + 100;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(kjsConfig, 'idempotent')) {
<span class="cstat-no" title="statement not covered" >      rdKafkaConfig['enable.idempotence'] = kjsConfig.idempotent;</span>
    }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(kjsConfig, 'transactionalId')) {
<span class="cstat-no" title="statement not covered" >      rdKafkaConfig['transactional.id'] = kjsConfig.transactionalId;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(kjsConfig, 'compression')) {
<span class="cstat-no" title="statement not covered" >      rdKafkaConfig['compression.codec'] = kjsConfig.compression;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(kjsConfig, 'acks')) {
<span class="cstat-no" title="statement not covered" >      rdKafkaConfig['acks'] = kjsConfig.acks;</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(kjsConfig, 'timeout')) {
<span class="cstat-no" title="statement not covered" >      rdKafkaConfig['request.timeout.ms'] = kjsConfig.timeout;</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return topics.flatMap(<span class="fstat-no" title="function not covered" >to</span>pic =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      return topic.partitions.map(<span class="fstat-no" title="function not covered" >pa</span>rtition =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        return { partition: Number(partition.partition), offset: String(partition.offset), topic: String(topic.topic) };</span>
      });
    });
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.#connectPromiseFunc["reject"](err);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.#state !== ProducerState.INITIALIZING_TRANSACTIONS) {</span>
      // FSM impossible state. We should add error handling for
      // this later.
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.#state = ProducerState.INITIALIZED_TRANSACTIONS;</span>
<span class="cstat-no" title="statement not covered" >    this.#readyCb();</span>
  }
&nbsp;
  /**
  ...
  #deliveryCallback(err, report) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!opaque || (typeof opaque.resolve !== 'function' &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >typeof opaque.reject !== 'function')</span>) {
      // not sure how to handle this.
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Internal error: deliveryCallback called without opaque set properly", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >      opaque.reject(createKafkaJsErrorFromLibRdKafkaError(err));</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
  async #readyCb() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.#state !== ProducerState.CONNECTING &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.#state !== ProducerState.INITIALIZED_TRANSACTIONS)</span> {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(rdKafkaConfig, 'transactional.id') &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.#state !== ProducerState.INITIALIZED_TRANSACTIONS)</span> {
<span class="cstat-no" title="statement not covered" >      this.#state = ProducerState.INITIALIZING_TRANSACTIONS;</span>
<span class="cstat-no" title="statement not covered" >      this.#logger.debug("Attempting to initialize transactions", this.#createProducerBindingMessageMetadata());</span>
<span class="cstat-no" title="statement not covered" >      this.#internalClient.initTransactions(5000 /* default: 5s */, this.#readyTransactions.bind(this));</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (this.#state &lt; ProducerState.CONNECTED) {</span>
...
<span class="cstat-no" title="statement not covered" >    this.#logger.error(err, this.#createProducerBindingMessageMetadata());</span>
  }
&nbsp;
  /**
   ...
   */
  async connect() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.#state !== ProducerState.INIT) {
...
&nbsp;
    ...
    this.#internalClient.on('event.log', <span class="fstat-no" title="function not covered" >(m</span>sg) =&gt; <span class="cstat-no" title="statement not covered" >loggerTrampoline(msg, this.#logger))</span>;
&nbsp;
    return new Promise((resolve, reject) =&gt; {
      this.#connectPromiseFunc = { resolve, reject };
      this.#internalClient.connect(null, (err) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >          this.#state = ProducerState.DISCONNECTED;</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.#state &gt;= ProducerState.DISCONNECTING) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  as</span>ync transaction() {
<span class="cstat-no" title="statement not covered" >    if (this.#state !== ProducerState.CONNECTED) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot start transaction without awaiting connect()", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.#ongoingTransaction) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Can only start one transaction at a time.", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.#logger.debug("Attempting to begin transaction", this.#createProducerBindingMessageMetadata());</span>
...
<span class="cstat-no" title="statement not covered" >      this.#internalClient.beginTransaction(<span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
<span class="cstat-no" title="statement not covered" >          reject(createKafkaJsErrorFromLibRdKafkaError(err));</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
<span class="cstat-no" title="statement not covered" >        this.#ongoingTransaction = true;</span>
&nbsp;
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  as</span>ync commit() {
<span class="cstat-no" title="statement not covered" >    if (this.#state !== ProducerState.CONNECTED) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot commit without awaiting connect()", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.#ongoingTransaction) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot commit, no transaction ongoing.", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.#logger.debug("Attempting to commit transaction", this.#createProducerBindingMessageMetadata());</span>
<span class="cstat-no" title="statement not covered" >    return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.#internalClient.commitTransaction(5000 /* default: 5000ms */, <span class="fstat-no" title="function not covered" >er</span>r =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
          // TODO: Do we reset ongoingTransaction here?
<span class="cstat-no" title="statement not covered" >          reject(createKafkaJsErrorFromLibRdKafkaError(err));</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
<span class="cstat-no" title="statement not covered" >        this.#ongoingTransaction = false;</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  as</span>ync abort() {
<span class="cstat-no" title="statement not covered" >    if (this.#state !== ProducerState.CONNECTED) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot abort without awaiting connect()", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.#ongoingTransaction) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot abort, no transaction ongoing.", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.#logger.debug("Attempting to abort transaction", this.#createProducerBindingMessageMetadata());</span>
<span class="cstat-no" title="statement not covered" >    return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.#internalClient.abortTransaction(5000 /* default: 5000ms */, <span class="fstat-no" title="function not covered" >er</span>r =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
          // TODO: Do we reset ongoingTransaction here?
<span class="cstat-no" title="statement not covered" >          reject(createKafkaJsErrorFromLibRdKafkaError(err));</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  as</span>ync sendOffsets(arg) {
    let { consumerGroupId, topics, consumer } = <span class="cstat-no" title="statement not covered" >arg;</span>
&nbsp;
    /* If the user has not supplied a consumer, or supplied a consumerGroupId, throw immediately. */
<span class="cstat-no" title="statement not covered" >    if (consumerGroupId || !consumer) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendOffsetsMustProvideConsumer(), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!Array.isArray(topics) || topics.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("sendOffsets arguments are invalid", { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.#state !== ProducerState.CONNECTED) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot sendOffsets without awaiting connect()", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this.#ongoingTransaction) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot sendOffsets, no transaction ongoing.", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.#internalClient.sendOffsetsToTransaction(</span>
        this.#flattenTopicPartitionOffsets(topics).map(topicPartitionOffsetToRdKafka),
        consumer._getInternalClient(),
<span class="fstat-no" title="function not covered" >        as</span>ync err =&gt; {
<span class="cstat-no" title="statement not covered" >          if (err)</span>
<span class="cstat-no" title="statement not covered" >            reject(createKafkaJsErrorFromLibRdKafkaError(err));</span>
          else
<span class="cstat-no" title="statement not covered" >            resolve();</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  is</span>Active() {
<span class="cstat-no" title="statement not covered" >    return this.#ongoingTransaction;</span>
  }
&nbsp;
  /**
  ...
  async send(sendOptions) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.#state !== ProducerState.CONNECTED) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot send without awaiting connect()", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (sendOptions === null || !(sendOptions instanceof Object)) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendOptionsMandatoryMissing(), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(sendOptions, 'acks')) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendOptionsAcks('send'), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(sendOptions, 'timeout')) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendOptionsTimeout('send'), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(sendOptions, 'compression')) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendOptionsCompression('send'), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
    const msgPromises = [];
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!Object.hasOwn(msg, "partition") || msg.partition === null) {
<span class="cstat-no" title="statement not covered" >        msg.partition = -1;</span>
      }
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof msg.value === 'string') {
        msg.value = Buffer.from(msg.value);
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.hasOwn(msg, "timestamp") &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >msg.timestamp)</span> {
<span class="cstat-no" title="statement not covered" >        msg.timestamp = Number(msg.timestamp);</span>
      } else {
        msg.timestamp = 0;
      }
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (currentRecordMetadata.baseOffset === null) {
<span class="cstat-no" title="statement not covered" >        continue;</span>
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (currentRecordMetadata.baseOffset &gt; recordMetadata.baseOffset) {
<span class="cstat-no" title="statement not covered" >        topicPartitionRecordMetadata.set(key, recordMetadata);</span>
      }
    }
&nbsp;
    const ret = [];
...
&nbsp;
  /**
    ...
    * @returns {Promise&lt;Array&lt;Object&gt;&gt;} Resolves with the record metadata for the messages.
  */
<span class="fstat-no" title="function not covered" >  as</span>ync sendBatch(sendOptions) {
<span class="cstat-no" title="statement not covered" >    if (this.#state !== ProducerState.CONNECTED) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot sendBatch without awaiting connect()", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (sendOptions === null || !(sendOptions instanceof Object)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendBatchMandatoryMissing(), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (Object.hasOwn(sendOptions, 'acks')) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendOptionsAcks('sendBatch'), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
<span class="cstat-no" title="statement not covered" >    if (Object.hasOwn(sendOptions, 'timeout')) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendOptionsTimeout('timeout'), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
<span class="cstat-no" title="statement not covered" >    if (Object.hasOwn(sendOptions, 'compression')) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendOptionsCompression('compression'), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (sendOptions.topicMessages !== null &amp;&amp; !Array.isArray(sendOptions.topicMessages)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.sendBatchMandatoryMissing(), { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!sendOptions.topicMessages || sendOptions.topicMessages.length === 0) {</span>
...
&nbsp;
    ...
    const sentPromises = <span class="cstat-no" title="statement not covered" >[];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (const topicMessage of sendOptions.topicMessages) {</span>
<span class="cstat-no" title="statement not covered" >      sentPromises.push(this.send(topicMessage));</span>
    }
&nbsp;
    const records = <span class="cstat-no" title="statement not covered" >await Promise.all(sentPromises);</span>
<span class="cstat-no" title="statement not covered" >    return records.flat();</span>
  }
&nbsp;
  /**
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  se</span>tSaslCredentials(args = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
<span class="cstat-no" title="statement not covered" >    if (!Object.hasOwn(args, 'username')) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("username must be set for setSaslCredentials", { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!Object.hasOwn(args, 'password')) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("password must be set for setSaslCredentials", { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
    /**
     ...
     */
<span class="cstat-no" title="statement not covered" >    if (this.#state &lt; ProducerState.CONNECTING) {</span>
<span class="cstat-no" title="statement not covered" >      this.#userConfig['sasl.username'] = args.username;</span>
<span class="cstat-no" title="statement not covered" >      this.#userConfig['sasl.password'] = args.password;</span>
<span class="cstat-no" title="statement not covered" >      if (Object.hasOwn(this.#userConfig, 'kafkaJS') &amp;&amp; Object.hasOwn(this.#userConfig.kafkaJS, 'sasl')) {</span>
<span class="cstat-no" title="statement not covered" >        this.#userConfig.kafkaJS.sasl.username = args.username;</span>
<span class="cstat-no" title="statement not covered" >        this.#userConfig.kafkaJS.sasl.password = args.password;</span>
      }
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.#logger.info("Setting SASL credentials", this.#createProducerBindingMessageMetadata());</span>
<span class="cstat-no" title="statement not covered" >    this.#internalClient.setSaslCredentials(args.username, args.password);</span>
  }
&nbsp;
  /**
   ...
   */
<span class="fstat-no" title="function not covered" >  as</span>ync flush(args = <span class="branch-0 cbranch-no" title="branch not covered" >{ timeout: 500 })</span> {
<span class="cstat-no" title="statement not covered" >    if (this.#state !== ProducerState.CONNECTED) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("Cannot flush without awaiting connect()", { code: error.ErrorCodes.ERR__STATE });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!Object.hasOwn(args, 'timeout')) {</span>
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError("timeout must be set for flushing", { code: error.ErrorCodes.ERR__INVALID_ARG });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.#logger.debug(`Attempting to flush messages for ${args.timeout}ms`, this.#createProducerBindingMessageMetadata());</span>
<span class="cstat-no" title="statement not covered" >    return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.#internalClient.flush(args.timeout, <span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (err) {</span>
          const kjsErr = <span class="cstat-no" title="statement not covered" >createKafkaJsErrorFromLibRdKafkaError(err);</span>
<span class="cstat-no" title="statement not covered" >          if (err.code === error.ErrorCodes.ERR__TIMED_OUT) {</span>
            /* See reason below for yield. Same here - but for partially processed delivery reports. */
<span class="cstat-no" title="statement not covered" >            setTimeout(<span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >reject(kjsErr),</span> 0);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            reject(kjsErr);</span>
          }
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
...
<span class="cstat-no" title="statement not covered" >        setTimeout(resolve, 0);</span>
      });
    });
  }
}
