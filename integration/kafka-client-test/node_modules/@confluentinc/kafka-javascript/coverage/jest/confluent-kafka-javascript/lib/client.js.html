    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>105/218</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>46/129</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">48.82% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>104/213</span>
            </div>
...
<span class="branch-1 cbranch-no" title="branch not covered" >        case 'stats':</span>
...
Client.prototype.connect = function(metadataOptions, cb) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._hasUnderlyingClient) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._isConnected) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._isConnecting) {
...
&nbsp;
  var fail = <span class="fstat-no" title="function not covered" >fu</span>nction(err) {
...
&nbsp;
  var self = this;
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._isDisconnecting &amp;&amp; this._client) {
...
Client.prototype.getMetadata = function(metadataOptions, cb) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.isConnected()) {
<span class="cstat-no" title="statement not covered" >    return cb(new Error('Client is disconnected'));</span>
  }
&nbsp;
  var self = this;
&nbsp;
  this._client.getMetadata(metadataOptions || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> function(err, metadata) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (errorCode !== LibrdKafkaError.codes.ERR_NO_ERROR) {
