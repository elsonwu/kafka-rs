...
<head>
    <title>Code coverage report for confluent-kafka-javascript/lib/kafkajs/_consumer_cache.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">confluent-kafka-javascript/lib/kafkajs</a> _consumer_cache.js</h1>
        <div class='clearfix'>
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    si</span>ze() {
<span class="cstat-no" title="statement not covered" >        return this.#cache.length;</span>
    }
&nbsp;
    /**
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    _n</span>ext() {
<span class="cstat-no" title="statement not covered" >        return this.#cache.removeFirst();</span>
    }
&nbsp;
    /**
...
&nbsp;
    constructor(logger) {
        this.logger = logger ?? <span class="branch-1 cbranch-no" title="branch not covered" >console;</span>
        this.#reinit();
    }
&nbsp;
    /**
...
&nbsp;
<span class="fstat-no" title="function not covered" >    ge</span>t availableSize() {
<span class="cstat-no" title="statement not covered" >        return this.#availablePartitions.length;</span>
    }
&nbsp;
    get assignedSize() {
...
&nbsp;
<span class="fstat-no" title="function not covered" >    ge</span>t size() {
...
&nbsp;
    ...
    markStale(topicPartitions) {
        for (const topicPartition of topicPartitions) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (!ppc)
                continue;
&nbsp;
<span class="cstat-no" title="statement not covered" >            this.#size -= ppc.size();</span>
<span class="cstat-no" title="statement not covered" >            if (ppc._assigned) {</span>
<span class="cstat-no" title="statement not covered" >                this.#assignedPartitions.remove(ppc._node);</span>
            } else {
<span class="cstat-no" title="statement not covered" >                this.#availablePartitions.remove(ppc._node);</span>
            }
<span class="cstat-no" title="statement not covered" >            this.#tpToPpc.delete(key);</span>
<span class="cstat-no" title="statement not covered" >            ppc._assigned = false;</span>
        }
    }
&nbsp;
    /**
...
&nbsp;
    ...
    return(ppc) {
        if (!ppc._assigned)
            return;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (ppc._node) {
            this.#assignedPartitions.remove(ppc._node);
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    ne</span>xt(ppc = <span class="branch-0 cbranch-no" title="branch not covered" >null)</span> {
<span class="cstat-no" title="statement not covered" >        if (!ppc|| !ppc._assigned)</span>
<span class="cstat-no" title="statement not covered" >            ppc = this.#assignNewPartition();</span>
<span class="cstat-no" title="statement not covered" >        if (!ppc)</span>
<span class="cstat-no" title="statement not covered" >            return null;</span>
&nbsp;
        let next = <span class="cstat-no" title="statement not covered" >ppc._next();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!next) {</span>
<span class="cstat-no" title="statement not covered" >            this.#removeEmptyPartition(ppc);</span>
...
<span class="cstat-no" title="statement not covered" >        return [next, ppc];</span>
    }
&nbsp;
    /**
     ...
     */
    nextN(ppc = <span class="branch-0 cbranch-no" title="branch not covered" >null,</span> size = <span class="branch-0 cbranch-no" title="branch not covered" >-1)</span> {
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    as</span>ync availablePartitions() {
<span class="cstat-no" title="statement not covered" >        return this.#availablePartitionsPromise;</span>
    }
}
&nbsp;
