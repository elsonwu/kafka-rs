...
<head>
    <title>Code coverage report for confluent-kafka-javascript/lib/kafkajs/_kafka.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">confluent-kafka-javascript/lib/kafkajs</a> _kafka.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { Producer, CompressionTypes } = require('./_producer');
...
&nbsp;
   ...
   */
  constructor(config) {
    this.#commonClientConfig = config ?? <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.kafkaJSCommonKey(disallowedKey));</span>
    }
  }
&nbsp;
  /**
  ...
  #mergeConfiguration(config) {
    config = Object.assign({}, config) ?? <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    const mergedConfig = Object.assign({}, this.#commonClientConfig);
&nbsp;
    mergedConfig.kafkaJS = Object.assign({}, mergedConfig.kafkaJS) ?? <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof config.kafkaJS === 'object') {
<span class="cstat-no" title="statement not covered" >      mergedConfig.kafkaJS = Object.assign(mergedConfig.kafkaJS, config.kafkaJS);</span>
<span class="cstat-no" title="statement not covered" >      delete config.kafkaJS;</span>
    }
&nbsp;
...
&nbsp;
  ...
  producer(config) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (disallowedKey !== null) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.kafkaJSClientKey(disallowedKey, 'producer'));</span>
    }
&nbsp;
...
&nbsp;
  ...
  consumer(config) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (disallowedKey !== null) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.kafkaJSClientKey(disallowedKey, 'consumer'));</span>
    }
&nbsp;
...
&nbsp;
  ...
  admin(config) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (disallowedKey !== null) {
<span class="cstat-no" title="statement not covered" >      throw new error.KafkaJSError(CompatibilityErrorMessages.kafkaJSClientKey(disallowedKey, 'admin'));</span>
    }
&nbsp;
