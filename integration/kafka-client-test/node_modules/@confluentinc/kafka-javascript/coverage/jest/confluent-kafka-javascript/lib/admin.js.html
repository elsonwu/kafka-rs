...
<head>
    <title>Code coverage report for confluent-kafka-javascript/lib/admin.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">confluent-kafka-javascript/lib</a> admin.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">24.89% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>57/229</span>
            </div>
...
<a name='L724'></a><a href='#L724'>724</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (eventHandlers &amp;&amp; typeof eventHandlers === 'object') {
 ...
 */
function <span class="fstat-no" title="function not covered" >createAdminClientFrom(</span>existingClient, eventHandlers) {
  var client = <span class="cstat-no" title="statement not covered" >new AdminClient(null, existingClient);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (eventHandlers &amp;&amp; typeof eventHandlers === 'object') {</span>
<span class="cstat-no" title="statement not covered" >    for (const key in eventHandlers) {</span>
<span class="cstat-no" title="statement not covered" >      client.on(key, eventHandlers[key]);</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  LibrdKafkaError.wrap(client.connect(), true);</span>
&nbsp;
  // Return the client if we succeeded
...
function AdminClient(conf, existingClient) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(this instanceof AdminClient)) {
<span class="cstat-no" title="statement not covered" >    return new AdminClient(conf);</span>
  }
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (conf) {
...
<span class="cstat-no" title="statement not covered" >    this._isConnected = true;</span>
<span class="cstat-no" title="statement not covered" >    this._hasUnderlyingClient = true;</span>
  } else {
...
AdminClient.prototype.connect = function () {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._hasUnderlyingClient) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof timeout === 'function') {
<span class="cstat-no" title="statement not covered" >    cb = timeout;</span>
<span class="cstat-no" title="statement not covered" >    timeout = 5000;</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!timeout) {
<span class="cstat-no" title="statement not covered" >    timeout = 5000;</span>
  }
&nbsp;
 ...
 * @param {function} cb - The callback to be executed when finished.
 */
AdminClient.prototype.deleteTopic = <span class="fstat-no" title="function not covered" >fu</span>nction (topic, timeout, cb) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.deleteTopic(topic, timeout, <span class="fstat-no" title="function not covered" >fu</span>nction (err) {</span>
 ...
 * @param {function} cb - The callback to be executed when finished.
 */
AdminClient.prototype.createPartitions = <span class="fstat-no" title="function not covered" >fu</span>nction (topic, totalPartitions, timeout, cb) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.createPartitions(topic, totalPartitions, timeout, <span class="fstat-no" title="function not covered" >fu</span>nction (err) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
 ...
 */
AdminClient.prototype.listGroups = <span class="fstat-no" title="function not covered" >fu</span>nction (options, cb) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.listGroups(options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, groups) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cb) {</span>
<span class="cstat-no" title="statement not covered" >      cb(null, groups);</span>
    }
  });
};
&nbsp;
 ...
 */
AdminClient.prototype.describeGroups = <span class="fstat-no" title="function not covered" >fu</span>nction (groups, options, cb) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.describeGroups(groups, options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, descriptions) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cb) {</span>
<span class="cstat-no" title="statement not covered" >      cb(null, descriptions);</span>
    }
  });
};
&nbsp;
 ...
 */
AdminClient.prototype.deleteGroups = <span class="fstat-no" title="function not covered" >fu</span>nction (groups, options, cb) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.deleteGroups(groups, options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, reports) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cb) {</span>
<span class="cstat-no" title="statement not covered" >      cb(null, reports);</span>
    }
  });
};
&nbsp;
 ...
 */
AdminClient.prototype.listTopics = <span class="fstat-no" title="function not covered" >fu</span>nction (options, cb) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  options.allTopics = true;</span>
...
<span class="cstat-no" title="statement not covered" >  this._client.getMetadata(options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, metadata) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
...
&nbsp;
    const topics = <span class="cstat-no" title="statement not covered" >[];</span>
<span class="cstat-no" title="statement not covered" >    if (metadata.topics) {</span>
<span class="cstat-no" title="statement not covered" >      for (const topic of metadata.topics) {</span>
<span class="cstat-no" title="statement not covered" >        topics.push(topic.name);</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (cb) {</span>
 ...
 * @param {function} cb - The callback to be executed when finished.
 */
AdminClient.prototype.listConsumerGroupOffsets = <span class="fstat-no" title="function not covered" >fu</span>nction (listGroupOffsets, options, cb) {
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!listGroupOffsets[0].groupId) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('groupId must be provided');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(!options) {</span>
<span class="cstat-no" title="statement not covered" >    options = {};</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!Object.hasOwn(options, 'requireStableOffsets')) {</span>
<span class="cstat-no" title="statement not covered" >    options.requireStableOffsets = false;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.listConsumerGroupOffsets(listGroupOffsets, options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, offsets) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
 ...
 * @param {function} cb - The callback to be executed when finished.
 */
AdminClient.prototype.deleteRecords = <span class="fstat-no" title="function not covered" >fu</span>nction (delRecords, options, cb) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!Object.hasOwn(options, 'operationTimeout')) {</span>
<span class="cstat-no" title="statement not covered" >    options.operationTimeout = 60000;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!Array.isArray(delRecords) || delRecords.length === 0) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('delRecords must be a non-empty array');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.deleteRecords(delRecords, options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, results) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
 ...
 * @param {function} cb - The callback to be executed when finished.
 */
AdminClient.prototype.describeTopics = <span class="fstat-no" title="function not covered" >fu</span>nction (topics, options, cb) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(!Object.hasOwn(options, 'includeAuthorizedOperations')) {</span>
<span class="cstat-no" title="statement not covered" >    options.includeAuthorizedOperations = false;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.describeTopics(topics, options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, descriptions) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
 ...
 * @param {function} cb - The callback to be executed when finished.
 */
AdminClient.prototype.listOffsets = <span class="fstat-no" title="function not covered" >fu</span>nction (partitions, options, cb) {
<span class="cstat-no" title="statement not covered" >  if (!this._isConnected) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Client is disconnected');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if(!Object.hasOwn(options, 'isolationLevel')) {</span>
<span class="cstat-no" title="statement not covered" >    options.isolationLevel = IsolationLevel.READ_UNCOMMITTED;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._client.listOffsets(partitions, options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, offsets) {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >        cb(LibrdKafkaError.create(err));</span>
      }
