...
<head>
    <title>Code coverage report for confluent-kafka-javascript/lib/kafkajs/_error.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">confluent-kafka-javascript/lib/kafkajs</a> _error.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">30.35% </span>
...
<a name='L299'></a><a href='#L299'>299</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
class KafkaJSError extends Error {
     ...
     */
    constructor(e, { retriable = false, fatal = false, abortable = false, stack = <span class="branch-0 cbranch-no" title="branch not covered" >null,</span> code = <span class="branch-0 cbranch-no" title="branch not covered" >LibrdKafkaError.codes.ERR_UNKNOWN </span>} = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
        super(e, {});
        /**
         * Name of the error.
         * @type {string}
         ...
         * @type {string}
         */
        this.message = e.message || <span class="branch-1 cbranch-no" title="branch not covered" >e;</span>
        /**
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (errTypes.length !== 1) {
<span class="cstat-no" title="statement not covered" >            this.type = LibrdKafkaError.codes.ERR_UNKNOWN;</span>
        } else {
...
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSProtocolError';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSOffsetOutOfRange';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSConnectionError';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSRequestTimeoutError';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSPartialMessageError';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSSASLAuthenticationError';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSGroupCoordinatorNotFound';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSNotImplemented';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSTimeout';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor(e, topicName, properties) {
<span class="cstat-no" title="statement not covered" >      super(e, properties);</span>
<span class="cstat-no" title="statement not covered" >      this.topic = topicName;</span>
<span class="cstat-no" title="statement not covered" >      this.name = 'KafkaJSCreateTopicError';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor(e, groups) {
<span class="cstat-no" title="statement not covered" >      super(e);</span>
<span class="cstat-no" title="statement not covered" >      this.groups = groups || [];</span>
<span class="cstat-no" title="statement not covered" >      this.name = 'KafkaJSDeleteGroupsError';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor({ partitions }) {
      /*
       * This error is retriable if all the errors were retriable
       */
      const retriable = <span class="cstat-no" title="statement not covered" >partitions</span>
        .filter(<span class="fstat-no" title="function not covered" >({</span> error }) =&gt; <span class="cstat-no" title="statement not covered" >error !== null)</span>
        .every(<span class="fstat-no" title="function not covered" >({</span> error }) =&gt; <span class="cstat-no" title="statement not covered" >error.retriable === true)</span>;
&nbsp;
<span class="cstat-no" title="statement not covered" >      super('Error while deleting records', { retriable });</span>
<span class="cstat-no" title="statement not covered" >      this.name = 'KafkaJSDeleteTopicRecordsError';</span>
<span class="cstat-no" title="statement not covered" >      this.partitions = partitions;</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor(message, errors) {
...
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSAggregateError';</span>
    }
}
&nbsp;
/**
...
<span class="fstat-no" title="function not covered" >    co</span>nstructor() {
<span class="cstat-no" title="statement not covered" >        super(...arguments);</span>
<span class="cstat-no" title="statement not covered" >        this.name = 'KafkaJSNoBrokerAvailableError';</span>
    }
}
&nbsp;
/**
 ...
 * @memberof KafkaJS
 */
const isRebalancing = <span class="fstat-no" title="function not covered" >e </span>=&gt;
<span class="cstat-no" title="statement not covered" >    e.type === 'REBALANCE_IN_PROGRESS' ||</span>
 ...
 * @memberof KafkaJS
 */
const isKafkaJSError = <span class="fstat-no" title="function not covered" >e </span>=&gt; <span class="cstat-no" title="statement not covered" >e instanceof KafkaJSError;</span>
&nbsp;
module.exports = {
    KafkaJSError,
